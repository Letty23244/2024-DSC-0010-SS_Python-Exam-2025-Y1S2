...
Revision ID: a3114c7e7f41
Revises: 
Create Date: 2025-05-23 11:31:38.915120
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nameOfCourse', sa.String(length=255), nullable=False),
    sa.Column('schedule', sa.String(length=100), nullable=False),
    sa.Column('course_unit', sa.String(length=50), nullable=False),
